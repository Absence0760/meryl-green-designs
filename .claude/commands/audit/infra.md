...
13. **Tagging.** Every resource that supports `tags` has them, and the tag set includes at minimum `project = "meryl-green-designs"`, `managed_by = "terraform"`. Tag-based cost attribution depends on this.
