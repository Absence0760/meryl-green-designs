...
#                   (default: meryl-green-designs-sops)
...
KMS_ALIAS_NAME="${KMS_ALIAS:-meryl-green-designs-sops}"
...
ensure_kms_key() {
	...
	if existing_key_id=$(aws kms describe-key \
		...
		key_id=$(aws kms create-key \
			--region "$KMS_REGION" \
			--description "SOPS secrets encryption for meryl-green-designs" \
			--key-usage ENCRYPT_DECRYPT \
			--tags TagKey=project,TagValue=meryl-green-designs \
