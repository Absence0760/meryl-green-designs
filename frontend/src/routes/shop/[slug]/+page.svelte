<script lang="ts">
	...
	onMount(async () => {
		// Demo mode: resolve from the hardcoded list instead of fetching.
		if (isDemoMode) {
			const match = demoProducts.find((p) => p.slug === slug);
		...
		{:else if notFound}
			<div class="alert">
				...
				<p>
					...
					<a href={`${base}/shop`}>Browse the shop</a> for what's currently available.
				</p>
			</div>
		{:else if error}
			...
			<div class="product-detail">
				...
				<div class="info">
					...
					<div class="info__cta">
						...
						<a class="info__back" href={`${base}/shop`}>← Back to shop</a>
					</div>
